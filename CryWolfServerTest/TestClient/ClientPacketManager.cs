...
class PacketManager
{
	...
	{		
		...
		_handler.Add((ushort)MessageId.SConnectSession, S_ConnectSessionHandler);		
	}
	...
	private void S_ConnectSessionHandler(PacketSession session, IMessage packet)
	{
		var connectPacket = (S_ConnectSession)packet;
		if (session is TestSession testSession)
		{
			testSession.SessionId = connectPacket.SessionId;
		}
	}
}